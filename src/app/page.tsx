  ...
  return (
    <div className="min-h-screen bg-white dark:bg-black/90 relative overflow-x-hidden">
      ...
      <main className="relative z-10 pt-16">
        ...
        >
          <div className="min-h-screen flex flex-col items-center justify-center px-4 text-white dark:text-gray-100">
            ...
            <ScrollAnimatedSection animation="slideUp" delay={400}>
              <h1 className="text-4xl md:text-6xl lg:text-7xl font-riveta-black text-white dark:text-gray-100 text-center mb-6 max-w-4xl">
            ...
            <ScrollAnimatedSection animation="slideUp" delay={600}>
              <p className="text-lg md:text-xl font-riveta text-gray-200 dark:text-gray-300 text-center mb-12 max-w-2xl">
            ...
            <ScrollAnimatedSection animation="slideUp" delay={800}>
              <Link 
                ...
                className="bg-orange-500 hover:bg-orange-600 text-white font-riveta-medium px-8 py-4 rounded-full text-lg transition-all duration-500 transform hover:scale-110 hover:shadow-2xl shadow-lg group"
              >
          ...
          <div className="max-w-6xl mx-auto px-4">
            ...
            <ScrollAnimatedSection animation="slideUp" delay={200}>
              <div className="text-center mb-16">
                <h2 className="text-3xl md:text-5xl font-riveta-medium text-black dark:text-black mb-4">
                  Why Choose <span className="text-orange-500">Eatopia</span>
                </h2>
                <p className="text-lg font-riveta text-gray-600 dark:text-black-300 dark:text-black-300 max-w-2xl mx-auto">
                ...
                <FloatingElement speed={0.01}>
                  <div className="text-center group cursor-pointer">
                    <div className="bg-white/90 dark:bg-black/80 backdrop-blur-sm border-2 border-gray-100 dark:border-gray-700 rounded-2xl p-8 mb-4 hover:border-orange-500 hover:shadow-2xl hover:bg-white dark:hover:bg-black/80 transition-all duration-500 group-hover:scale-110 group-hover:-translate-y-2">
                      ...
                      <h3 className="text-xl font-riveta-medium text-black dark:text-white mb-3 group-hover:text-orange-600 transition-colors duration-300">Explore</h3>
                      <p className="font-rivetatext-gray-600 dark:text-gray-300 dark:text-gray-300 text-sm">
                ...
                <FloatingElement speed={0.015}>
                  <div className="text-center group cursor-pointer">
                    <div className="bg-white/90 dark:bg-black/80 backdrop-blur-sm border-2 border-gray-100 dark:border-gray-700 rounded-2xl p-8 mb-4 hover:border-orange-500 hover:shadow-2xl hover:bg-white dark:hover:bg-black/80 transition-all duration-500 group-hover:scale-110 group-hover:-translate-y-2">
                      ...
                      <h3 className="text-xl font-riveta-medium text-black dark:text-white mb-3 group-hover:text-orange-600 transition-colors duration-300">Discover</h3>
                      <p className="font-rivetatext-gray-600 dark:text-gray-300 dark:text-gray-300 text-sm">
                ...
                <FloatingElement speed={0.012}>
                  <div className="text-center group cursor-pointer">
                    <div className="bg-white/90 dark:bg-black/80 backdrop-blur-sm border-2 border-gray-100 dark:border-gray-700 rounded-2xl p-8 mb-4 hover:border-orange-500 hover:shadow-2xl hover:bg-white dark:hover:bg-black/80 transition-all duration-500 group-hover:scale-110 group-hover:-translate-y-2">
                      ...
                      <h3 className="text-xl font-riveta-medium text-black dark:text-white mb-3 group-hover:text-orange-600 transition-colors duration-300">Connect</h3>
                      <p className="font-rivetatext-gray-600 dark:text-gray-300 dark:text-gray-300 text-sm">
                ...
                <FloatingElement speed={0.008}>
                  <div className="text-center group cursor-pointer">
                    <div className="bg-white/90 dark:bg-black/80 backdrop-blur-sm border-2 border-gray-100 dark:border-gray-700 rounded-2xl p-8 mb-4 hover:border-orange-500 hover:shadow-2xl hover:bg-white dark:hover:bg-black/80 transition-all duration-500 group-hover:scale-110 group-hover:-translate-y-2">
                      ...
                      <h3 className="text-xl font-riveta-medium text-black dark:text-white mb-3 group-hover:text-orange-600 transition-colors duration-300">Experience</h3>
                      <p className="font-rivetatext-gray-600 dark:text-gray-300 dark:text-gray-300 text-sm">
        ...
        <section className="py-20 bg-black/5 dark:bg-black/80 relative overflow-hidden">
          ...
          <div className="max-w-6xl mx-auto px-4 relative z-10">
            <ScrollAnimatedSection animation="slideUp" delay={200}>
              <div className="text-center mb-16">
                <h2 className="text-3xl md:text-5xl font-riveta-medium text-black dark:text-white mb-4">
                  How It <span className="text-orange-500">Works</span>
                </h2>
                <p className="text-lg font-rivetatext-gray-600 dark:text-gray-300 dark:text-gray-300 max-w-2xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-12">
                ...
                <FloatingElement speed={0.005}>
                  <div className="text-center group">
                    <div className="w-20 h-20 bg-orange-500 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:bg-orange-600 group-hover:scale-110 transition-all duration-500 shadow-lg group-hover:shadow-2xl">
                      <span className="text-white font-riveta-medium text-2xl group-hover:scale-110 transition-transform duration-300">1</span>
                    </div>
                    <h3 className="text-xl font-riveta-medium text-black dark:text-white mb-4 group-hover:text-orange-600 transition-colors duration-300">Browse & Search</h3>
                    <p className="font-rivetatext-gray-600 dark:text-gray-300">
              ...
              <ScrollAnimatedSection animation="slideUp" delay={400}>
                <FloatingElement speed={0.008}>
                  <div className="text-center group">
                    <div className="w-20 h-20 bg-orange-500 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:bg-orange-600 group-hover:scale-110 transition-all duration-500 shadow-lg group-hover:shadow-2xl">
                      <span className="text-white font-riveta-medium text-2xl group-hover:scale-110 transition-transform duration-300">2</span>
                    </div>
                    <h3 className="text-xl font-riveta-medium text-black dark:text-white mb-4 group-hover:text-orange-600 transition-colors duration-300">Book & Connect</h3>
                    <p className="font-rivetatext-gray-600 dark:text-gray-300">
              ...
              <ScrollAnimatedSection animation="slideInRight" delay={500}>
                <FloatingElement speed={0.006}>
                  <div className="text-center group">
                    <div className="w-20 h-20 bg-orange-500 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:bg-orange-600 group-hover:scale-110 transition-all duration-500 shadow-lg group-hover:shadow-2xl">
                      <span className="text-white font-riveta-medium text-2xl group-hover:scale-110 transition-transform duration-300">3</span>
                    </div>
                    <h3 className="text-xl font-riveta-medium text-black dark:text-white mb-4 group-hover:text-orange-600 transition-colors duration-300">Enjoy & Share</h3>
                    <p className="font-rivetatext-gray-600 dark:text-gray-300">
        ...
        >
          <div className="max-w-4xl mx-auto text-center px-4">
            <ScrollAnimatedSection animation="zoomIn" delay={200}>
              <h2 className="text-3xl md:text-5xl font-riveta-medium text-white mb-6">
                Ready to Discover Your Next <span className="text-orange-400">Culinary Adventure?</span>
              </h2>
            </ScrollAnimatedSection>
            
            <ScrollAnimatedSection animation="slideUp" delay={400}>
              <p className="text-lg font-rivetatext-gray-200 mb-8 max-w-2xl mx-auto">
            ...
            <ScrollAnimatedSection animation="slideUp" delay={600}>
              <FloatingElement speed={0.01}>
                <Link 
                  href="/create-experience"
                  className="bg-orange-500 hover:bg-orange-600 text-white font-riveta-medium px-8 py-4 rounded-full text-lg transition-all duration-500 transform hover:scale-110 hover:shadow-2xl shadow-lg group relative overflow-hidden"
                >
